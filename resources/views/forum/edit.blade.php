            ...
            <div class="container px-4 px-lg-5">
                <div class="row gx-4 gx-lg-5 justify-content-center">
                    <div class="col-lg-8 col-xl-6 text-center">
                        ...
                        <hr class="divider" />
                        @if($locale === 'fr')
                        <p class="text-muted mb-5"> @if(isset($blogPost->titre)) {{ $blogPost->titre }} @else {{ $blogPost->title }} @endif </p>
                        @else
                        <p class="text-muted mb-5">{{ $blogPost->title }}</p>
                        @endif
                    </div>
                </div>
                        ...
                        <form class="row" id="contactForm" method="POST">
                            ...
                            <div class="mb-3 col-lg-6">
                                ...
                                <div class="form-floating mb-3">
                                    <input class="form-control" id="title" name="title" type="text" placeholder="Écrivez un titre..." data-sb-validations="required" value="{{ $blogPost->title }}"/>
                                ...
                                <!-- Body input-->
                                <div class="form-floating mb-3">
                                    <textarea class="form-control" id="body" name="body" placeholder="Écrivez un article..." data-sb-validations="required">{{ $blogPost->body }}</textarea>
                            ...
                            <div class="mb-3 col-lg-6">
                                ...
                                <div class="form-floating mb-3">
                                    <input class="form-control" id="titre" name="titre" type="text" placeholder="Écrivez un titre..." data-sb-validations="required" value="{{ $blogPost->titre }}"/>
                                ...
                                <!-- Body français input-->
                                <div class="form-floating mb-3">
                                    <textarea class="form-control" id="texte" name="texte" placeholder="Écrivez un article..." data-sb-validations="required">{{ $blogPost->texte }}</textarea>
