            ...
            <div class="container px-4 px-lg-5">
                <div class="row gx-4 gx-lg-5 justify-content-center">
                    <div class="col-lg-8 col-xl-6 text-center">
                        <h2 class="mt-0">@lang('lang.create_user')</h2>
                        <hr class="divider" />
                ...
                <div class="row gx-4 gx-lg-5 justify-content-center mb-5">
                    <div class="col-lg-6">
                        ...
                        @endif
                        <form id="contactForm" action="{{ route('user.store') }}" method="POST">
                            @csrf
                            <!-- Nom input-->
                            ...
                            <!-- Submit Button-->
                            <div class="d-grid"><button class="btn btn-primary btn-xl" id="submitButton" type="submit">@lang('lang.create_user')</button></div>
                        </form>
                    </div>
                </div>
            </div>
